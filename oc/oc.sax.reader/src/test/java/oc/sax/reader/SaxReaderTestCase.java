...
/**
 * This is more or less a black box test. The content of the test osm file is
 * known, and the text simply tests whether the content is read out correctly.
 * 
 * @author oliver
 */
public class SaxReaderTestCase {

	/**
	 * Test method for
	 * {@link oc.sax.reader.SaxReader#readFile(java.io.File, oc.osm.handler.OsmHandler)}
	 * .
	 * 
	 * @throws IOException
	 */
	...
	public void testReadFile() throws IOException {
		final InputStream is = SaxReaderTestCase.class.getResourceAsStream("junit.osm.gz");
		final File f = File.createTempFile("junit_test", "osm");
		FileUtils.copyInputStreamToFile(is, f);

		SaxReader.readFile(f, new OsmHandler() {
